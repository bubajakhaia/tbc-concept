  ...
  return (
    <div className="container">
      ...
      <div style={{ margin: "50px auto", padding: "40px 120px" }}>
        <p>გამარჯობა,</p>
        <p>
          თიბისი კონცეპტის შეთავაზების ფარგლებში, შესაძლებლობა გაქვთ, ისარგებლოთ
          50%-იანი ფასდაკლებით ავტომობილის დიაგნოსტიკისა და თვლის ნახრის
          გასწორების სერვისზე - თეგეტა მოტორსში. შეთავაზება ძალაშია 2024 წლის 12
          ივლისიდან - 30 სექტემბრის ჩათვლით. გადახდა უნდა განხორციელდეს მხოლოდ
          ფიზიკურ ობიექტში, თიბისის POS ტერმინალზე. შეთავაზება ვრცელდება შემდეგ
          სადებეტო ბარათებსა და მათ ციფრულ ანალოგებზე: TBC Concept Visa
          Platinum, Visa Signature, MC World Elite.
        </p>
      </div>
      <div>
        <OffersSlider />
