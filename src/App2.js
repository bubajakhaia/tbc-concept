...
// import LifestyleOffers from "./pages/LifestyleOffers";
  ...
  return (
    <div className="App">
      ...
      <div className="nav-fix">
        {/* <Navigationv3 language={language} setLanguage={setLanguage}/> */}
        {/* <Navigationv2 language={language} setLanguage={setLanguage}/> */}
