...
import ProductOfSlide from './ProductOfSlide';
...
const ProductsSlide = () => {
  ...
  return (
    ...
    <h2 className='products-header'>{language==="ge"?"პროდუქტები":"Products"}</h2>
